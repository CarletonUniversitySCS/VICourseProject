...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;localhost;ldgend;Password#2015;;mydb;;1"; //currently unused
		
		$this->_connectionsIdByName["mydb at localhost"] = "mydb_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "ldgend";
		$data["ODBCPWD"] = "Password#2015";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "ldgend";
		$data["connInfo"][2] = "Password#2015";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "mydb";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=ldgend;Pwd=Password#2015;Database=mydb;OPTION=3";
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["course"] = "mydb_at_localhost";
		$connectionsIds["drop"] = "mydb_at_localhost";
		$connectionsIds["selection"] = "mydb_at_localhost";
		$connectionsIds["instructor"] = "mydb_at_localhost";
		$connectionsIds["student"] = "mydb_at_localhost";
		$connectionsIds["tag"] = "mydb_at_localhost";
		$connectionsIds["courseChart"] = "mydb_at_localhost";
		$connectionsIds["selectionChart"] = "mydb_at_localhost";
		$connectionsIds["tagChart"] = "mydb_at_localhost";
