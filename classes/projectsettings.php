...
function GetTableURL($table = "")
{
	...
	if("tag" == $table) 
		return "tag";
	if("courseChart" == $table) 
		return "courseChart";
	if("selectionChart" == $table) 
...
{	
	...
	if("drop" == $shortTName) 
		return "drop";
	if("selection" == $shortTName) 
		return "selection";
	if("instructor" == $shortTName) 
		return "instructor";
	if("student" == $shortTName) 
		return "student";
	if("tag" == $shortTName) 
		return "tag";
	if("courseChart" == $shortTName) 
		return "courseChart";
	if("selectionChart" == $shortTName) 
		return "selectionChart";
	if("tagChart" == $shortTName) 
		return "tagChart";
}
