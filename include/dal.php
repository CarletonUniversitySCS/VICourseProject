...
class tDAL
{
	var $tblmydb_at_localhost__course;
	var $tblmydb_at_localhost__drop;
	var $tblmydb_at_localhost__instructor;
	var $tblmydb_at_localhost__selection;
	var $tblmydb_at_localhost__student;
	var $tblmydb_at_localhost__tag;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "course", "varname" => "mydb_at_localhost__course", "altvarname" => "course", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "drop", "varname" => "mydb_at_localhost__drop", "altvarname" => "drop", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "instructor", "varname" => "mydb_at_localhost__instructor", "altvarname" => "instructor", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "selection", "varname" => "mydb_at_localhost__selection", "altvarname" => "selection", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "student", "varname" => "mydb_at_localhost__student", "altvarname" => "student", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "tag", "varname" => "mydb_at_localhost__tag", "altvarname" => "tag", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
	}
