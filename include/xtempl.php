...
class XTempl
{
	...
	function XTempl( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("courseChart_chart","xt_showchart",array("chartname"=>"courseChart","table"=>"courseChart","ctype"=>"Bubble"));
			$this->assign_function("selectionChart_chart","xt_showchart",array("chartname"=>"selectionChart","table"=>"selectionChart","ctype"=>"Bubble"));
			$this->assign_function("tagChart_chart","xt_showchart",array("chartname"=>"tagChart","table"=>"tagChart","ctype"=>"2DPie"));
		}
