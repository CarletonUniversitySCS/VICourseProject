...
function checkTableName($shortTName, $type=false)
{
	...
	if ("course" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("drop" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("selection" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("instructor" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("student" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tag" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("courseChart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("selectionChart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("tagChart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	return false;
}
...
{
	if($shorttable=="courseChart")
		return "Bubble";
	if($shorttable=="selectionChart")
		return "Bubble";
	if($shorttable=="tagChart")
		return "2DPie";
	return "";
}
...
function GetUserPermissions($table="")
{
	...
	if($table=="courseChart")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="selectionChart")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="tagChart")
